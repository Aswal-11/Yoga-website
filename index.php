...
<!-- Description -->
<div class="bg-gradient-to-br from-light-blue via-white to-deep-blue py-16 lg:py-24 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mt-16 lg:mt-20">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-12">
                <!-- Feature 1 -->
                <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-white/20">
